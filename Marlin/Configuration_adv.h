...
// @section lcd
  ...
  #define SHORT_MANUAL_Z_MOVE 0.04 // (mm) Smallest manual Z move (< 0.1mm)
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_FEEDRATE   55  // (mm/s) Load filament feedrate. This can be pretty fast.
  ...
  #define ADVANCED_PAUSE_PURGE_LENGTH         85  // (mm) Length to extrude after loading.
